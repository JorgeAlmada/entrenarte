...
import './CourseCatalogComponent.css';
...
class CourseCatalogComponent extends Component {
   constructor(props){
     super(props);
     this.state = {
       courses : [],
  ...
  componentDidMount(){
    ...
    const self = this;
    axios.post(
      'http://localhost:8000/courses/getuserscourses',
      body,
      config
      )
      .then(res => {
              ...
              <div className="topic1 hero-bg"> 
                <div className="uk-grid" uk-grid> 
                  <div className="uk-width-1-2@m"> 
                    <h1 className="uk-animation-fade"> Mis cursos  </h1> 
                    <p> Cursos a los que estoy inscrito.</p> 
              ...
              <div className="uk-container"> 
                ...
                <div className="uk-child-width-1-2@s uk-child-width-1-3@m uk-grid-match uk-margin uk-grid" uk-scrollspy="cls: uk-animation-slide-bottom-small; target: > div ; delay: 200" uk-grid> 
                  ...
                  {this.state.courses.map((course, index) => {
                    if(course.status) return <div key={course.id} onClick={() => this.props.courseFunc(course)}> 
